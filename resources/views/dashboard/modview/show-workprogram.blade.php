<x-sidebar-layout>
    <x-slot name="header">
        <x-breadcrumb :links="['Dashboard' => auth()->user()->getDashboardRoute(), 'Supervisi Department' => route('dashboard.modview.department.index'), $workProgram->department->name => route('dashboard.modview.department.show', ['department' => $workProgram->department]), $workProgram->name => null]" />
    </x-slot>
